...
list_of_songs = ['music/memories.mp3', 'music/City.wav', 'music/Pehla Nasha.mp3']
list_of_covers = ['images/af.jpg', 'images/cf.jpg', 'images/coffee.jpg']
n = 0
...
def get_album_cover(song_name, n):
    ...
    song_name_label.place(relx=0.45, rely=0.6)
